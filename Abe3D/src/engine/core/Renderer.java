...
import engine.buffer.ColorBuffer;
import engine.buffer.DepthBuffer;
import engine.math.Mat4;
import engine.math.Vec4;
import engine.rasterizer.TriangleRasterizer;
...
public class Renderer {
	...
	public void setProjectionTransform(Transform projectionTransform) {
	...
	public void setMatrixMode(MatrixMode matrixMode) {
		...
		switch(matrixMode) {
			...
			case VIEW: currentTransform = viewTransform; break;
			case PROJECTION: currentTransform = projectionTransform;
		}
	}
	...
	public void scale(double sx, double sy, double sz) {
		currentTransform.translate(sx, sy, sz);
	}
	...
	public void begin() {
		vertexIndex = 0;
		mvp.set(projectionTransform.getMatrix());
		mvp.multiply(viewTransform.getMatrix());
	...
	public void setVertexExtraData(double[] vertexExtraDatas) {
