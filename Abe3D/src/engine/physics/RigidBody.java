...
public class RigidBody {
	...
	public void onCollisionEnter(RigidBody rigidBody, Contact contact) {
		for(ContactListener listener : listeners) {
			listener.onCollisionEnter(rigidBody, contact);
		}
	}
	
	public void onCollision(RigidBody rigidBody, Contact contact) {
		for(ContactListener listener : listeners) {
			listener.onCollision(rigidBody, contact);
		}
	}
	
	public void onCollisionOut(RigidBody rigidBody, Contact contact) {
		for(ContactListener listener : listeners) {
			listener.onCollisionOut(rigidBody, contact);
		}
	}
	
	@Override
	public String toString(){
		return "RigidBody{" + name + ", " + visible + ", " + sensor + ", " + dynamic + ", " + mass + ", " + angle + ", " + restitution;
	}
}